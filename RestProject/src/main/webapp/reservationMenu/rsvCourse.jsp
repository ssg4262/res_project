...
<section>
		...
		<c:if test="${resvCourseMenuList !=null && resvCourseMenuList.size()>0 }">
  ...
  <div id="myCarousel" class="carousel slide shadow-lg" data-bs-ride="carousel" >
    ...
    <div class="container">
		...
		<!-- 향상된포문과 유사 -->
		<c:forEach var="course" items="${resvCourseMenuList}" varStatus="status">
	...
	<c:if test="${resvCourseMenuList == null}">
