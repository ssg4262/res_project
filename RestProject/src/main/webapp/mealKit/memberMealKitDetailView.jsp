...
<body>
	...
	<c:if test="${myOrderDetailList != null && myOrderDetailList.size() > 0 }">
			...
			<div class="row align-items-center g-lg-5 py-5">
				<div class="col-lg-7 text-center text-lg-start">
					...
					<c:choose>
						...
						<c:when test="${meal_order_status eq 'order'}">
							<h1 class="display-4 fw-bold lh-1 mb-3">주문 확인 중입니다.</h1>
				...
				<div class="col-md-10 mx-auto col-lg-5 mx-auto text-center">
					<div class="p-4 p-md-5 border rounded-3 bg-light shadow-lg">
						...
						<c:forEach var="myOrderDetailList" items="${myOrderDetailList}"
							varStatus="status">
							...
							<h2 class="text-muted">
								<b>예약메뉴</b> <br> ${myOrderDetailList.meal_name}
							</h2>
							<br>
							<p class="text-muted">
								<b>예약금액</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;${myOrderDetailList.meal_price}
							</p>

						</c:forEach>
						<p class="text-muted">
							<b>예약 메뉴 수량</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;${myOrderDetailList.quantity}
						</p>
						...
						<strong> 주문상태</strong> :
						<c:choose>
							<c:when test="${meal_order_status eq 'order'}">예약 대기 상태</c:when>
							<c:when test="${meal_order_status eq 'get'}">예약  완료</c:when>
	...
	<c:if test="${myOrderDetailList == null }">
