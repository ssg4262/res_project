...
public class CalendarMonthSalesManageService {
	// 멤버변수
	// 기본생성자
	// 메서드

	public int getMonthSalesTotalMoney(String order_month) {
		...
		int monthSalesTotalMoney = adminDAO.selectMonthSalesTotalMoney(order_month);
