...
public class MealKitManageAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (mGRADE == null || !mGRADE.equalsIgnoreCase("Admin")) {
			...
			request.setAttribute("adminMealKit", "/admin/mealKitMainImage.jsp");
			
			request.setAttribute("showAdmin", "/admin/adminTemplate.jsp");
			
			forward = new ActionForward("admin/adminMain.jsp", false);
			//forward = new ActionForward("admin/mealKit.jsp", false);
